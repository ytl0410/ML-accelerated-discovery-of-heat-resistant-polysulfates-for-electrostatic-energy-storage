...
model_1 = tf.keras.models.load_model('DC_model.h5')
...
Corr_df = pickle.load(open("Corr_DC.pickle","rb"))
unique_list = pickle.load(open("unique_list_DC.pickle","rb"))
Columns = pickle.load(open("Columns_DC.pickle","rb"))
Substructure_list = pickle.load(open("polymer.keys_DC.pickle","rb"))
